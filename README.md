...
│   └── gojek/    # Vite + React 19 gojek.io tech site + mock candidate hub (Tailwind v4, TS)
└── packages/
...
# run one app
pnpm dev:kddi      # or dev:nab / … / commbank / employmenthero / hub24 / atlassian / gojek

# build one app
pnpm build:seek    # or build:kddi / … / build:employmenthero / build:hub24 / build:atlassian / build:gojek
