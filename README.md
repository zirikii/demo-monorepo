...
│   └── commbank/ # Vite + React 19 commbank.com.au clone + mock NetBank (Tailwind v4, TS)
└── packages/
...
| commbank | `cn` class merger (`src/lib/cn.ts` re-exports `@demo/ui/cn`) + `<DemoRibbon>` in header and NetBank |
