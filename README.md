...
# run one app
pnpm dev:kddi      # or dev:nab / dev:naukri / dev:paytm / dev:seek / dev:squiz / dev:changi

# build one app
pnpm build:seek    # or build:kddi / build:nab / build:naukri / build:paytm / build:squiz / build:changi
