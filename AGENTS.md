...
| employment-hero (Vite + React 19) | `pnpm dev:employment-hero` | 5180         | employmenthero.com clone + mock platform; intentional `/login` bug             |
...
- Lint: `pnpm lint` (root) runs across
  kddi/naukri/seek/spark/paytm/squiz/changi/nine/optus/commbank/employment-hero + `@demo/ui`
  typecheck; nab has no linter.
- Tests: the real unit suites are Vitest in kddi, naukri, seek, spark, changi, nine, commbank, and
  employment-hero (run `pnpm test`
