      ...
      <section className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
        <div className="mb-6 space-y-4 rounded-xl border border-line bg-card p-4 shadow-sm">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <input
              ...
              placeholder="Search outlet name or category"
              className="w-full rounded-md border border-line bg-surface px-3 py-2 text-sm outline-none ring-purple focus:ring-2 lg:max-w-sm"
        ...
        {rows.length === 0 ? (
          <EmptyState
            ...
            description="Try another terminal, switch between Dining and Shopping, or clear your search."
          />
        ) : (
        ...
        <p className="mt-4 text-xs text-ink-faint">
          Showing {rows.length} demo outlets — details are illustrative.
        </p>
      </section>
    </PageLayout>
  );
