  ...
  return (
    <div className="max-w-lg rounded-lg border border-line bg-white p-6">
      ...
      <dl className="mt-6 space-y-4 text-sm">
        <div>
          <dt className="font-semibold text-spark-ink/60">Name</dt>
          <dd className="mt-1">{user?.name}</dd>
        </div>
        <div>
          <dt className="font-semibold text-spark-ink/60">Email</dt>
          <dd className="mt-1">{user?.email}</dd>
        </div>
        <div>
          <dt className="font-semibold text-spark-ink/60">Demo hint</dt>
          <dd className="mt-1">
