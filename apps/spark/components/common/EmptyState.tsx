...
export function EmptyState({
  ...
  return (
    ...
    >
      <div className="flex h-14 w-14 items-center justify-center rounded-full bg-spark-purple-light text-spark-purple">
        <Icon className="h-7 w-7" />
      </div>
      <h3 className="mt-4 text-lg font-semibold text-spark-ink">{title}</h3>
      {description ? (
