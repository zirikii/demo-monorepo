...
The **Sport** page (`/sport`) lists Wide World of Sports stories with a Latest / Category sort.
Latest uses `getByPillar("sport")` (newest `publishedAt` first). Card timestamps pass ISO
`publishedAt` into `formatRelativeTime`, matching other pillars.
