...
The **Sport** page (`/sport`) lists Wide World of Sports stories newest-first when
**Latest** is selected, and card timestamps use ISO `publishedAt` via `formatRelativeTime`.
