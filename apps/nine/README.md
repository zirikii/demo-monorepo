...
The **Sport** page (`/sport`) now matches the other section hubs:

1. **Latest sort** shows newest stories first.
2. **Timestamps** are formatted from each article's ISO `publishedAt` value.
