...
The **Sport** page (`/sport`) matches the shared section behavior:

1. **Latest** sorts stories by `publishedAt` newest-first.
2. Story timestamps are formatted from each article's ISO `publishedAt` value.
