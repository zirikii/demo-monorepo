...
export const RESOURCES: Resource[] = [
  {
    ...
    type: "Guide",
    excerpt: "A walkthrough of how teams use Teamwork Graph context to let agents plan, update, and report without another tool.",
  ...
  },
  {
    ...
    type: "Report",
    excerpt: "Research on teams that kept context in one system versus teams that added a new AI tool for every workflow.",
  ...
  },
  {
    ...
    type: "Ebook",
    excerpt: "How Atlassian customers are transforming work right now — without standing up a parallel AI stack.",
  ...
  },
  {
    ...
    type: "Announcement",
    excerpt: "How we think about agents, collections, and keeping customer data in the customer's control.",
