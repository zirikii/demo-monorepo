      ...
      <Section>
        <div className="grid gap-8 md:grid-cols-3">
          {[
            {
              title: "Team first",
              body: "We build for the way people actually work together — not the org chart on a slide.",
            },
            {
              title: "Open company, no bullshit",
              body: "Say what you mean, write it down, and leave the work where the next person can find it.",
            },
            {
              title: "Play, as a team",
              body: "The best software comes from people who still like working with each other on Friday.",
            },
          ].map((value) => (
