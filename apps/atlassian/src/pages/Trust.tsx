    ...
    <PageLayout title="Trust">
      ...
      <Section>
        <ul className="grid gap-6 md:grid-cols-3">
          {[
            { title: "Security", body: "Encryption in transit and at rest, admin controls, and audit logs in the mock workspace." },
            { title: "Compliance", body: "Designed around common frameworks (SOC 2, ISO 27001, GDPR) as marketing copy only." },
            { title: "Reliability", body: "Cloud SLAs up to 99.95% on Enterprise — not measured in this demo." },
          ].map((item) => (
