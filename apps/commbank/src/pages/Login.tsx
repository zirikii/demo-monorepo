...
function resolveService(key: string | null): ServiceConfig {
  const normalized = (key ?? "netbank").toLowerCase();
  if (Object.hasOwn(serviceConfig, normalized)) {
    return serviceConfig[normalized as keyof typeof serviceConfig];
  }
