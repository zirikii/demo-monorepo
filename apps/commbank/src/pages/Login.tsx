...
export function LoginPage() {
  ...
  const serviceKey = (searchParams.get("service") ?? "netbank").toLowerCase();
  const service = serviceConfig[serviceKey as keyof typeof serviceConfig] ?? serviceConfig.netbank;
