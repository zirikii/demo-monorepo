...
export function SolutionsPage() {
  ...
  return (
    <PageLayout>
      <PageHero eyebrow="Solutions" title="Solutions" description="Employment Hero for small business, enterprise and accounting partners." actions={<ButtonLink to="/request-demo">Request a demo</ButtonLink>} />
      <Section>
        <div className="container-eh prose-like max-w-3xl space-y-4 text-[15px] leading-relaxed text-ink-soft">
          <p>Employment Hero for small business, enterprise and accounting partners.</p>
