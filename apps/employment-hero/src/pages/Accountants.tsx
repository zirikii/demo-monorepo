...
export function AccountantsPage() {
  useDocumentTitle("Accountants & bookkeepers");
  return (
    <PageLayout>
      <PageHero eyebrow="Solutions" title="Accountants & bookkeepers" description="Manage multiple client entities with payroll and advisory workflows." actions={<ButtonLink to="/request-demo">Request a demo</ButtonLink>} />
      <Section>
        <div className="container-eh prose-like max-w-3xl space-y-4 text-[15px] leading-relaxed text-ink-soft">
          <p>Manage multiple client entities with payroll and advisory workflows.</p>
