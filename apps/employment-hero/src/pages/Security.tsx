...
export function SecurityPage() {
  ...
  return (
    <PageLayout>
      <PageHero eyebrow="Legal" title="Security" description="Mock security overview — real Employment Hero maintains independent certifications." actions={<ButtonLink to="/request-demo">Request a demo</ButtonLink>} />
      <Section>
        <div className="container-eh prose-like max-w-3xl space-y-4 text-[15px] leading-relaxed text-ink-soft">
          <p>Mock security overview — real Employment Hero maintains independent certifications.</p>
