...
export function PartnersPage() {
  ...
  return (
    <PageLayout>
      <PageHero eyebrow="Company" title="Partners" description="Consulting, accounting and technology partners who implement Employment Hero." actions={<ButtonLink to="/request-demo">Request a demo</ButtonLink>} />
      <Section>
        <div className="container-eh prose-like max-w-3xl space-y-4 text-[15px] leading-relaxed text-ink-soft">
          <p>Consulting, accounting and technology partners who implement Employment Hero.</p>
