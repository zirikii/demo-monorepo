...
export function EnterprisePage() {
  ...
  return (
    <PageLayout>
      <PageHero eyebrow="Solutions" title="Enterprise" description="Configurable permissions, SSO and scale for complex organisations." actions={<ButtonLink to="/request-demo">Request a demo</ButtonLink>} />
      <Section>
        <div className="container-eh prose-like max-w-3xl space-y-4 text-[15px] leading-relaxed text-ink-soft">
          <p>Configurable permissions, SSO and scale for complex organisations.</p>
