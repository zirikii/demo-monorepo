...
export function CareersPage() {
  ...
  return (
    <PageLayout>
      <PageHero eyebrow="Company" title="Careers" description="Join a global team building HR, payroll and hiring software." actions={<ButtonLink to="/request-demo">Request a demo</ButtonLink>} />
      <Section>
        <div className="container-eh prose-like max-w-3xl space-y-4 text-[15px] leading-relaxed text-ink-soft">
          <p>Join a global team building HR, payroll and hiring software.</p>
