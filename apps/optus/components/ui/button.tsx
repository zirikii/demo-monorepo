  ...
  "inline-flex items-center justify-center gap-2 rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-optus-teal focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        yellow: "bg-optus-yellow text-optus-ink hover:bg-optus-yellow-soft",
        secondary: "border border-optus-teal bg-white text-optus-teal hover:bg-optus-teal-soft",
        ghost: "bg-transparent text-optus-ink hover:bg-optus-teal-soft",
        dark: "bg-optus-ink text-white hover:bg-optus-teal-dark",
        link: "h-auto bg-transparent p-0 text-optus-teal underline-offset-4 hover:underline",
      },
      size: { default: "h-11 px-5 py-2", sm: "h-9 px-3 text-xs", lg: "h-12 px-7 text-base" },
    },
