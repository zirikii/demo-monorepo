  ...
  return (
    <div className="max-w-lg rounded-lg border border-line bg-white p-6">
      ...
      <dl className="mt-6 space-y-4 text-sm">
        <div>
          <dt className="font-semibold text-optus-ink/60">Phone</dt>
          <dd className="mt-1">{settings.profile.phone}</dd>
        </div>
        <div>
          <dt className="font-semibold text-optus-ink/60">Address</dt>
          <dd className="mt-1">{settings.profile.address}</dd>
        </div>
        <div>
          <dt className="font-semibold text-optus-ink/60">Preferred contact</dt>
